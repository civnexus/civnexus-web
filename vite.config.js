...
const newPlaceImages = {
  '/prime-reserves.webp': ${JSON.stringify(readFileSync('public/prime-reserves.webp').toString('base64'))},
  '/ines.webp': ${JSON.stringify(readFileSync('public/ines.webp').toString('base64'))},
